                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full border-collapse text-left">
                    <thead className="bg-slate-950 text-white">
                      <tr>
                        <th className="px-5 py-4 text-[11px] font-semibold uppercase tracking-[0.22em]">Customer</th>
                        <th className="px-5 py-4 text-[11px] font-semibold uppercase tracking-[0.22em]">Pay term</th>
                    ...
                    <tbody>
                      {rows.map((row) => (
                        <tr className="border-t border-slate-900/6" key={row.custNo}>
                          <td className="px-5 py-4 font-semibold text-slate-900">{row.customerName}</td>
                          <td className="px-5 py-4 text-sm text-slate-600">{row.payterm || "N/A"}</td>
